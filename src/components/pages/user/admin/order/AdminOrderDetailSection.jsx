...
const AdminOrderDetailSection = ({ orders, handleOrderStatus,activeFilter,setActiveFilter }) => {
      ...
      <div className="flex border-b border-gray-200">
        ...
        >
         ...
         <button
          ...
          className={`px-4 py-2 text-sm font-medium ${activeFilter === "pending" ? "text-[#8b5a2b] border-b-2 border-[#8b5a2b]" : "text-gray-500 hover:text-gray-700"}`}
        >
        Pending
        </button>
          <button
        ...
        >
          ...
          className={`px-4 py-2 text-sm font-medium ${activeFilter === "shipped" ? "text-[#8b5a2b] border-b-2 border-[#8b5a2b]" : "text-gray-500 hover:text-gray-700"}`}
        >
          Shipped
        </button>
        ...
        >
          ...
          className={`px-4 py-2 text-sm font-medium ${activeFilter === "cancel" ? "text-[#8b5a2b] border-b-2 border-[#8b5a2b]" : "text-gray-500 hover:text-gray-700"}`}
        >
          Cancelled
        </button>
                  ...
                  >
                    <div className="px-4 pb-4 border-t border-gray-100">
                      ...
                      <div className="flex space-x-3 mt-6">
                        ...
                        {
                          order.orderStatus.includes("PENDING") || order.orderStatus.includes("PROCESSING") &&
                          ...
                          <button className="px-4 py-2 text-sm bg-[#2c2c2c] text-white rounded-full hover:opacity-90 transition-opacity"
                              onClick={() => handleOrderStatus({orderId:order.id,orderStatus:"PROCESSING"})}
                            >
                              Accept
                            </button>
                          }
